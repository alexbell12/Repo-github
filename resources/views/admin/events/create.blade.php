...
<div class="max-w-2xl mx-auto">
    <div class="card-glass rounded-2xl p-8">
        ...
        <p class="text-white/80 text-sm mb-6">Isi data event di bawah ini</p>
        ...
        <form method="POST" action="{{ route('admin.events.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="4" placeholder="Masukkan deskripsi event"
                    class="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/50 focus:ring-2 focus:ring-white/30">{{ old('description') }}</textarea>
            </div>
